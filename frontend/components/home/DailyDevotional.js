...
export default function DailyDevotional() {
  ...
  const devotional = {
    ...
    excerpt: "Faith is not just believing in God, but trusting Him completely with every aspect of our lives...",
    ...
    <section className="py-16 bg-white">
      <div className="container-custom">
        ...
        >
          ...
          <p className="section-subtitle">Daily spiritual nourishment for your walk with Christ</p>
        </motion.div>
        ...
        >
          ...
          <div className="bg-primary-50 p-6 rounded-lg mb-6 border-l-4 border-primary-400">
            <p className="text-sm font-semibold text-primary-700 mb-2">{devotional.scripture.reference}</p>
            <p className="text-gray-700 italic">{devotional.scripture.text}</p>
          </div>

          <p className="text-gray-600 mb-6 leading-relaxed">{devotional.excerpt}</p>
